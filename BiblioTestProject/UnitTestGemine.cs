...
{
    public class UnitTestGemine
    {
        [Fact]
        public async Task TestObtenerResumenLibroIA()
        {
            // Leemos la API key desde app.settings.json
            ...
            var prompt = $"Me puedes dar un resumen de 200 palabras como máximo del principito";
        ...
        [Fact]
        public async Task TestServiceGeminiPromp()
        {
